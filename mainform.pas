...
begin
  ...
  begin
    ...
    cmbFrequency.Caption := 'Giornaliero';
...
begin
  ...
  try
    ...
    try
      ...
      J.Add('cmbCompressionLevel', cmbCompressionLevel.Caption);
      J.Add('cmbFrequency', cmbFrequency.Caption);
      J.Add('cmbDayOfWeek', cmbDayOfWeek.Caption);
